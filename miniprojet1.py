# -*- coding: utf-8 -*-
"""
Created on Sun Dec 12 21:30:21 2021
...
class Login:
   ...
   def login(self):
      ...
      if self.email_txt.get()=="" or self.password.get()=="":
         ...
         try:
            ...
            con=pymysql.connect(host='localhost',user='hiba',password ='24021995h' ,
   ...
   def appscreen(self):
      ...
      label1=Label(Frame_login,text="Hi! Welcome To Hiba platform"
      ...
      label2=Label(Frame_login,text="Welcome if you are a new Member"
      ...
      label3=Label(Frame_login,text="You Will Find All Python Courses Here"
